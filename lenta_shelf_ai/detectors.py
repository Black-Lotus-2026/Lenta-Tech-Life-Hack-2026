...
class YOLODetector(BaseDetector):
    ...
    def __init__(self, weights: str | Path, conf: float = 0.25, iou: float = 0.5, imgsz: int = 1280, device: str = ""):
        ...
        for res in results:
            ...
            for box, score in zip(xyxy, confs):
                ...
                if x2 - x1 > 8 and y2 - y1 > 8:
                    detections.append(Detection(x1, y1, x2, y2, float(score), source="yolo"))
        return detections
