...
QR_FIELD_ALIASES: Dict[str, List[str]] = {
    "qr_code_barcode": ["barcode", "b", "ean", "gtin", "gtin13"],
    "price1_qr": ["price1", "p1"],
    "price2_qr": ["price2", "p2"],
    "price3_qr": ["price3", "p3"],
    "price4_qr": ["price4", "p4"],
...
class TagObservation:
    ...
    focus_quality: Dict[str, Any] = field(default_factory=dict)
    visual_hash: str = ""
    qr_debug: Dict[str, Any] = field(default_factory=dict)
    zone_debug: Dict[str, Any] = field(default_factory=dict)
